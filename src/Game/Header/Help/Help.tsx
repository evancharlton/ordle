            ...
            <Accordion initial="rules">
              <Segment id="rules" title="Reglene">
                <div className={classes.section}>
                  Hver omgang har et hemmelig ord som består av fem bokstaver.
                  Du har seks forsøk på å finne det riktige ordet. Lykke til!
                </div>
                <hr />
                <div className={classes.section}>
                  <Letter letter="ø" mode="yes" />
                  <p>
                    Hvis en bokstav ser ut som dette, er den riktige bokstaven
                    på den riktige plassen. Bra!
                  </p>
                </div>
                <div className={classes.section}>
              ...
              <Segment id="words" title="«Hva er disse ordene?»">
                ...
                <blockquote>
                  ...
                  tabellen inneholder også former som er tenkelige, men i
                  praksis brukes sjelden eller aldri.
                </blockquote>
              </Segment>
            </Accordion>
          </div>
